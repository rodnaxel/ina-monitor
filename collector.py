...
class DataCollector:
    def __init__(self, max_points=300, debug=False):
        self.ina219 = INA219() if not debug else FakeINA219()
    ...
    def start(self, sample_rate_hz=10):
        ...
        self.running = True
        self.thread = threading.Thread(target=self._collect, args=(sample_rate_hz,), daemon=True)
        self.thread.start()
